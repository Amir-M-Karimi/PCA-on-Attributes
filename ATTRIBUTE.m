...
depth=bound-Topw;
[Hws1]=Wit_Frc_calc (x1,N,winlength);
[ Avg1, Cv1, R1, theta1]=Wit_Sta_calc (x1,N,winlength);
[wwnew,wwnew1,wwnew2] = PCA_witness(Avg1,Cv1,R1,theta1);
Witstat=wwnew';
sigdis=0.152344;
...
[Hws]= Fractal_calc(x2,N,winlength);
[ Avg,Cv,R, theta]=Statis_calc(x2,N,winlength);
[ownew] = PCA_observation(Avg,Cv,R,theta);
Obstat=ownew';
...
[Prob,Probability]=Prob_calc (x2,N,WFeatures,OFeatures,StdFeatures,Num,win,winlength,sigdis);
%% probability plots
